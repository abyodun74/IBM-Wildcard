...
const IL_PROVIDERS = [
  ...
  { name: "Riverside Health Clinic",     state: "NY", zip: "10002", specialty: "Internal medicine", distance: "1.2 mi",  rating: 4.5, years: 22, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish","Yoruba"],    insurance: "medium", accessibility: ["elevator","transportation"],         tags: ["Accessible","Spanish","Yoruba"] },
  { name: "Dr. Robert Chen",             state: "PA", zip: "19101", specialty: "Internal medicine", distance: "1.8 mi",  rating: 4.6, years: 20, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Mandarin","Cantonese"],insurance: "high",   accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone","Mandarin"] },
  ...
  { name: "Dr. Yemi Adeyemi",            state: "MD", zip: "20601", specialty: "OB-GYN",            distance: "2.5 mi",  rating: 4.8, years: 16, gender: "Female", nonprofit: false, verified: true,  awards: ["Excellence in Women's Health"], asl: false, phone: true,  languages: ["English","Yoruba"],              insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone","Yoruba"] },
  { name: "Baltimore Health Hub",        state: "MD", zip: "21201", specialty: "Psychiatry",        distance: "1.3 mi",  rating: 4.5, years: 9,  gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  ...
  { name: "Boston Community Clinic",     state: "MA", zip: "02110", specialty: "General practice",  distance: "0.4 mi",  rating: 4.3, years: 18, gender: "Mixed",  nonprofit: true,  verified: true,  awards: ["HRSA Gold Award"],             asl: true,  phone: true,  languages: ["English","Spanish","Haitian Creole"], insurance: "low", accessibility: ["elevator","ramp","transportation"], tags: ["Accessible","ASL","Phone","Spanish"] },
  { name: "Dr. Linh Nguyen",             state: "CT", zip: "06101", specialty: "Pediatrics",        distance: "1.4 mi",  rating: 4.8, years: 8,  gender: "Female", nonprofit: false, verified: true,  awards: ["Patient Choice Award"],        asl: false, phone: true,  languages: ["English","Vietnamese"],          insurance: "medium", accessibility: ["ramp"],                             tags: ["Accessible","Phone"] },
  { name: "Hartford Health Center",      state: "CT", zip: "06103", specialty: "Internal medicine", distance: "0.8 mi",  rating: 4.2, years: 25, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Marcus Webb",             state: "NJ", zip: "07101", specialty: "Family medicine",   distance: "1.1 mi",  rating: 4.5, years: 13, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone"] },
  { name: "Newark Community Health",     state: "NJ", zip: "07102", specialty: "General practice",  distance: "0.5 mi",  rating: 4.1, years: 20, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Portuguese"], insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone","Spanish"] },
  ...
  { name: "Dr. Thomas Briggs",           state: "VT", zip: "05401", specialty: "General practice",  distance: "3.0 mi",  rating: 4.4, years: 17, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
  { name: "Dr. Sandra Lopes",            state: "RI", zip: "02901", specialty: "Internal medicine", distance: "1.5 mi",  rating: 4.5, years: 14, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Portuguese"],          insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Dr. Paul Donovan",            state: "ME", zip: "04101", specialty: "Family medicine",   distance: "4.0 mi",  rating: 4.3, years: 22, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
  ...
  { name: "Dr. James Calloway",          state: "DE", zip: "19801", specialty: "Internal medicine", distance: "1.7 mi",  rating: 4.4, years: 16, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone"] },
  ...
  { name: "Dr. Maria Gonzalez",          state: "FL", zip: "33125", specialty: "Pediatrics",        distance: "2.2 mi",  rating: 4.8, years: 10, gender: "Female", nonprofit: false, verified: true,  awards: ["Top Pediatrician 2024"],       asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "medium", accessibility: ["ramp"],                             tags: ["Accessible","Spanish"] },
  { name: "Dr. Aisha Williams",          state: "GA", zip: "30301", specialty: "Family medicine",   distance: "1.4 mi",  rating: 4.6, years: 8,  gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Atlanta Health Center",       state: "GA", zip: "30303", specialty: "Internal medicine", distance: "0.7 mi",  rating: 4.3, years: 20, gender: "Mixed",  nonprofit: true,  verified: true,  awards: ["Community Award 2023"],        asl: true,  phone: true,  languages: ["English","Spanish","Mandarin"],  insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Darnell Jackson",         state: "NC", zip: "27601", specialty: "Family medicine",   distance: "1.6 mi",  rating: 4.5, years: 12, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Raleigh Community Care",      state: "NC", zip: "27602", specialty: "General practice",  distance: "0.9 mi",  rating: 4.2, years: 18, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Tanya Rivers",            state: "SC", zip: "29201", specialty: "OB-GYN",            distance: "2.0 mi",  rating: 4.7, years: 15, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone"] },
  { name: "Dr. Marcus Stone",            state: "AL", zip: "35201", specialty: "Internal medicine", distance: "1.8 mi",  rating: 4.3, years: 19, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Birmingham Free Clinic",      state: "AL", zip: "35203", specialty: "General practice",  distance: "1.1 mi",  rating: 4.0, years: 28, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["ramp","transportation"],             tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Crystal Haynes",          state: "MS", zip: "39201", specialty: "Family medicine",   distance: "2.3 mi",  rating: 4.4, years: 9,  gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["ramp"],                             tags: ["Phone"] },
  { name: "Dr. Ray Perkins",             state: "TN", zip: "37201", specialty: "Family medicine",   distance: "1.3 mi",  rating: 4.5, years: 14, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Nashville Health Hub",        state: "TN", zip: "37203", specialty: "Psychiatry",        distance: "0.8 mi",  rating: 4.6, years: 11, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Beau Thibodaux",          state: "LA", zip: "70112", specialty: "Internal medicine", distance: "1.5 mi",  rating: 4.4, years: 17, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","French"],              insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone","French"] },
  { name: "New Orleans Community Clinic",state: "LA", zip: "70113", specialty: "Family medicine",   distance: "0.7 mi",  rating: 4.2, years: 22, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","French"],    insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Priya Nair",              state: "VA", zip: "23219", specialty: "Pediatrics",        distance: "1.6 mi",  rating: 4.9, years: 9,  gender: "Female", nonprofit: false, verified: true,  awards: ["Patient Choice Award"],        asl: false, phone: true,  languages: ["English","Hindi"],               insurance: "high",   accessibility: ["ramp"],                             tags: ["Accessible","Hindi"] },
  { name: "Richmond Care Center",        state: "VA", zip: "23220", specialty: "General practice",  distance: "1.0 mi",  rating: 4.3, years: 16, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Olivia Marsh",            state: "WV", zip: "25301", specialty: "Family medicine",   distance: "3.5 mi",  rating: 4.2, years: 20, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
  { name: "Dr. Kwame Asante",            state: "AR", zip: "72201", specialty: "Internal medicine", distance: "1.9 mi",  rating: 4.4, years: 13, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Dr. Naomi Silverstein",       state: "KY", zip: "40202", specialty: "Family medicine",   distance: "1.2 mi",  rating: 4.6, years: 11, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },

  // ── Midwest ──
  { name: "City Community Clinic",       state: "IL", zip: "60601", specialty: "Family medicine",   distance: "0.5 mi",  rating: 4.3, years: 30, gender: "Mixed",  nonprofit: true,  verified: true,  awards: ["HRSA Gold Award"],             asl: true,  phone: true,  languages: ["English","Spanish","Mandarin"],  insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone","Spanish","Mandarin"] },
  { name: "Dr. Leon Harris",             state: "IL", zip: "60614", specialty: "Psychiatry",        distance: "2.8 mi",  rating: 4.7, years: 11, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","French"],              insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone","French"] },
  { name: "Dr. Fatima Hassan",           state: "MI", zip: "48201", specialty: "Psychiatry",        distance: "2.0 mi",  rating: 4.9, years: 12, gender: "Female", nonprofit: false, verified: true,  awards: ["Mental Health Champion"],      asl: false, phone: true,  languages: ["English","Arabic","French"],     insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone","Arabic"] },
  { name: "Detroit Free Clinic",         state: "MI", zip: "48202", specialty: "General practice",  distance: "1.5 mi",  rating: 4.1, years: 35, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Arabic"],    insurance: "low",    accessibility: ["ramp","transportation"],             tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Grace Kim",               state: "OH", zip: "43215", specialty: "Internal medicine", distance: "1.3 mi",  rating: 4.6, years: 14, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Korean"],              insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Columbus Health Partners",    state: "OH", zip: "43216", specialty: "Family medicine",   distance: "0.9 mi",  rating: 4.3, years: 20, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Somali"],    insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Samuel Carter",           state: "IN", zip: "46201", specialty: "Family medicine",   distance: "1.7 mi",  rating: 4.4, years: 16, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone"] },
  { name: "Dr. Anna Kowalski",           state: "WI", zip: "53201", specialty: "OB-GYN",            distance: "1.4 mi",  rating: 4.7, years: 13, gender: "Female", nonprofit: false, verified: true,  awards: ["Top OB 2023"],                 asl: false, phone: true,  languages: ["English","Polish"],              insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Milwaukee Community Health",  state: "WI", zip: "53202", specialty: "General practice",  distance: "0.6 mi",  rating: 4.2, years: 24, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Hmong"],     insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. David Olsen",             state: "MN", zip: "55401", specialty: "Family medicine",   distance: "1.8 mi",  rating: 4.5, years: 18, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Somali","Hmong"],      insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Twin Cities Health Clinic",   state: "MN", zip: "55402", specialty: "Psychiatry",        distance: "1.0 mi",  rating: 4.6, years: 10, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Somali"],    insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Laura Bennett",           state: "IA", zip: "50301", specialty: "Family medicine",   distance: "2.1 mi",  rating: 4.4, years: 15, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["ramp"],                             tags: ["Phone"] },
  { name: "Dr. Eric Johannsen",          state: "MO", zip: "63101", specialty: "Internal medicine", distance: "1.6 mi",  rating: 4.5, years: 17, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "St. Louis Free Clinic",       state: "MO", zip: "63103", specialty: "General practice",  distance: "0.8 mi",  rating: 4.1, years: 26, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Bosnian"],   insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Helen Kruger",            state: "KS", zip: "66101", specialty: "Family medicine",   distance: "2.4 mi",  rating: 4.3, years: 19, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["ramp"],                             tags: ["Phone"] },
  { name: "Dr. Aaron Tate",              state: "NE", zip: "68101", specialty: "General practice",  distance: "3.0 mi",  rating: 4.2, years: 21, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
  { name: "Dr. Patricia Holt",           state: "SD", zip: "57101", specialty: "Family medicine",   distance: "4.5 mi",  rating: 4.1, years: 23, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Lakota"],              insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
  { name: "Dr. Frank Larson",            state: "ND", zip: "58101", specialty: "General practice",  distance: "5.0 mi",  rating: 4.0, years: 27, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },

  // ── South Central ──
  { name: "Rural Health Partners",       state: "TX", zip: "75001", specialty: "General practice",  distance: "18 mi",   rating: 4.2, years: 25, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["ramp","transportation"],             tags: ["Rural","Phone","Spanish"] },
  { name: "Dr. Sofia Reyes",             state: "TX", zip: "77001", specialty: "OB-GYN",            distance: "1.9 mi",  rating: 4.8, years: 13, gender: "Female", nonprofit: false, verified: true,  awards: ["Best OB 2022"],                asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Spanish"] },
  { name: "Dr. James Okonkwo",           state: "TX", zip: "77002", specialty: "Internal medicine", distance: "3.1 mi",  rating: 4.5, years: 18, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Yoruba"],              insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone","Yoruba"] },
  { name: "Dr. Rosa Mendoza",            state: "OK", zip: "73101", specialty: "Family medicine",   distance: "2.0 mi",  rating: 4.4, years: 12, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["ramp"],                             tags: ["Phone"] },

  // ── Mountain West ──
  { name: "Dr. Andrew Pierce",           state: "CO", zip: "80201", specialty: "Family medicine",   distance: "1.5 mi",  rating: 4.6, years: 14, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Denver Community Health",     state: "CO", zip: "80202", specialty: "Internal medicine", distance: "0.7 mi",  rating: 4.4, years: 20, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Somali"],    insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Mia Torres",              state: "AZ", zip: "85001", specialty: "Internal medicine", distance: "1.6 mi",  rating: 4.5, years: 11, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish","Navajo"],    insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Phoenix Free Clinic",         state: "AZ", zip: "85003", specialty: "Family medicine",   distance: "0.9 mi",  rating: 4.2, years: 22, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Carlos Montoya",          state: "NM", zip: "87101", specialty: "Family medicine",   distance: "2.2 mi",  rating: 4.4, years: 16, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish","Navajo"],    insurance: "low",    accessibility: ["ramp"],                             tags: ["Phone"] },
  { name: "Dr. Jessica Thorne",          state: "UT", zip: "84101", specialty: "Family medicine",   distance: "1.8 mi",  rating: 4.5, years: 13, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Dr. Brian Hollis",            state: "NV", zip: "89101", specialty: "Internal medicine", distance: "1.4 mi",  rating: 4.4, years: 15, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "medium", accessibility: ["elevator"],                         tags: ["Phone"] },
  { name: "Las Vegas Health Hub",        state: "NV", zip: "89102", specialty: "General practice",  distance: "0.8 mi",  rating: 4.2, years: 20, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Tagalog"],   insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Rachel Flynn",            state: "ID", zip: "83701", specialty: "Family medicine",   distance: "3.5 mi",  rating: 4.3, years: 18, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Spanish"],             insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
  { name: "Dr. Nathan Cole",             state: "MT", zip: "59601", specialty: "General practice",  distance: "5.0 mi",  rating: 4.1, years: 24, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Crow"],                insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
  { name: "Dr. Karen Peck",              state: "WY", zip: "82001", specialty: "Family medicine",   distance: "6.0 mi",  rating: 4.0, years: 26, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English"],                       insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },

  // ── Pacific ──
  { name: "Dr. Priya Nair (LA)",         state: "CA", zip: "90001", specialty: "Pediatrics",        distance: "1.6 mi",  rating: 4.9, years: 9,  gender: "Female", nonprofit: false, verified: true,  awards: ["Patient Choice Award"],        asl: false, phone: true,  languages: ["English","Hindi"],               insurance: "high",   accessibility: ["ramp"],                             tags: ["Accessible","Hindi"] },
  { name: "Dr. Marcus Lee",              state: "CA", zip: "90210", specialty: "Dermatology",       distance: "2.1 mi",  rating: 4.6, years: 17, gender: "Male",   nonprofit: false, verified: false, awards: [],                              asl: true,  phone: false, languages: ["English"],                       insurance: "high",   accessibility: ["elevator"],                         tags: ["ASL"] },
  { name: "LA Community Health Center",  state: "CA", zip: "90011", specialty: "Family medicine",   distance: "0.7 mi",  rating: 4.3, years: 25, gender: "Mixed",  nonprofit: true,  verified: true,  awards: ["HRSA Gold Award"],             asl: true,  phone: true,  languages: ["English","Spanish","Mandarin","Tagalog"], insurance: "low", accessibility: ["elevator","ramp","transportation"], tags: ["Accessible","ASL","Phone","Spanish"] },
  { name: "Dr. Kevin Park",              state: "WA", zip: "98101", specialty: "Dermatology",       distance: "1.1 mi",  rating: 4.7, years: 15, gender: "Male",   nonprofit: false, verified: true,  awards: ["Best Dermatologist 2022"],     asl: false, phone: true,  languages: ["English","Korean"],              insurance: "high",   accessibility: ["elevator"],                         tags: ["Phone","Korean"] },
  { name: "Seattle Community Health",    state: "WA", zip: "98104", specialty: "Family medicine",   distance: "0.9 mi",  rating: 4.5, years: 28, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Vietnamese"], insurance: "low",   accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone","Spanish"] },
  { name: "Dr. Mei Lin",                 state: "OR", zip: "97201", specialty: "Internal medicine", distance: "1.3 mi",  rating: 4.6, years: 12, gender: "Female", nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Mandarin"],            insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Portland Community Clinic",   state: "OR", zip: "97202", specialty: "Family medicine",   distance: "0.6 mi",  rating: 4.3, years: 20, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Spanish","Russian"],   insurance: "low",    accessibility: ["elevator","ramp","transportation"],  tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Kalani Akana",            state: "HI", zip: "96813", specialty: "Family medicine",   distance: "1.2 mi",  rating: 4.7, years: 14, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Hawaiian","Tagalog"],  insurance: "medium", accessibility: ["elevator","ramp"],                  tags: ["Accessible","Phone"] },
  { name: "Honolulu Health Center",      state: "HI", zip: "96814", specialty: "General practice",  distance: "0.5 mi",  rating: 4.4, years: 18, gender: "Mixed",  nonprofit: true,  verified: true,  awards: [],                              asl: true,  phone: true,  languages: ["English","Tagalog","Ilocano","Japanese"], insurance: "low", accessibility: ["elevator","ramp","transportation"], tags: ["Accessible","ASL","Phone"] },
  { name: "Dr. Jake Muñoz",              state: "AK", zip: "99501", specialty: "General practice",  distance: "8.0 mi",  rating: 4.2, years: 20, gender: "Male",   nonprofit: false, verified: true,  awards: [],                              asl: false, phone: true,  languages: ["English","Yupik"],               insurance: "low",    accessibility: ["ramp"],                             tags: ["Rural","Phone"] },
];
