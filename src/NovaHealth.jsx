  ...
  return (
    <div>
      ...
      >
        ...
        >
          <span aria-hidden="true" style={{ color: t.accent, fontSize: 14 }}>
            ◈
          </span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
          {[
            {
              href: "https://price.healthfinder.fl.gov/#!care-bundles",
              label: "Florida care cost estimator",
              sub: "Compare costs for common procedures",
            },
            {
              href: state
                ? `https://www.healthcare.gov/see-plans/#/plan/results?state=${state}`
                : "https://www.healthcare.gov/see-plans/#/plan/results",
              label: "See what insurance would cover",
              sub: "Compare ACA Marketplace plans",
            },
            {
              href: "https://dollarfor.org/",
              label: "Dollar For — charity care assistance",
              sub: "Nonprofit that handles hospital bill forgiveness paperwork",
            },
            {
              href: "https://www.healthwellfoundation.org/",
              label: "HealthWell Foundation grants",
              sub: "Premiums, deductibles, and co-pays for chronic conditions",
            },
            {
              href: "https://www.usa.gov/health-insurance",
              label: "USA.gov — government health insurance guide",
              sub: "Medicaid, CHIP, marketplace, and more",
            },
          ].map((item, i) => (
            <a
              key={item.href}
            ...
            >
              <div>
                <div
                  style={{ fontSize: 12.5, fontWeight: 600, color: t.accent }}
                >
                  {item.label}
                </div>
              ...
              <span
                aria-hidden="true"
                style={{ color: t.mute, fontSize: 13, flexShrink: 0 }}
              >
                →
              </span>
            </a>
